...
public class DimmerSpeechSettingActivity extends AppCompatActivity implements CompoundButton.OnCheckedChangeListener {
    ...
    private Switch switch_turn_reserve, switch_get_on, switch_get_off, switch_dimming_percent;
    private EditText et_dimming_prefix;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dimmer_speech_setting);
    ...
    private void init_view() {
        ...
        et_get_on = findViewById(R.id.et_get_on);
        et_get_off = findViewById(R.id.et_get_off);
        et_dimming_prefix = findViewById(R.id.et_dimming_prefix);
        ...
        switch_dimming_percent = findViewById(R.id.switch_dimming_percent);
        ...
        switch_dimming_percent.setOnCheckedChangeListener(this::onCheckedChanged);
        ...
        spinner_select_lang.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (position == 0) {
                    PreferenceUtils.set(DimmerSpeechSettingActivity.this, Global.LANGUAGE_SETTING, "en-US");
                    PreferenceUtils.set(DimmerSpeechSettingActivity.this, Global.LANGUAGE_SETTING_PREFIX, "en");
                    stDefaultLanguage = "en-US";
                } else if (position == 1){
                    PreferenceUtils.set(DimmerSpeechSettingActivity.this, Global.LANGUAGE_SETTING, "pl-PL");
                    PreferenceUtils.set(DimmerSpeechSettingActivity.this, Global.LANGUAGE_SETTING_PREFIX, "pl");
                    stDefaultLanguage = "pl-PL";
                }
                PreferenceUtils.set(DimmerSpeechSettingActivity.this, Global.LANGUAGE_SELECTED, position);
            ...
            public void onNothingSelected(AdapterView<?> parent) {
                PreferenceUtils.set(DimmerSpeechSettingActivity.this, Global.LANGUAGE_SETTING, "en-US");
                PreferenceUtils.set(DimmerSpeechSettingActivity.this, Global.LANGUAGE_SETTING_PREFIX, "en");
                PreferenceUtils.set(DimmerSpeechSettingActivity.this, Global.LANGUAGE_SELECTED, 0);
            }
        });
    ...
    public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
        ...
        switch (buttonView.getId()) {
            ...
            case R.id.switch_get_off:
                ...
                break;
            case R.id.switch_dimming_percent:
                et_dimming_prefix.setEnabled(isChecked);
                break;
        }
    }
    ...
    private void setEnableAllSwitch(boolean check) {
        ...
        if (!check) {
            ...
            switch_dimming_percent.setEnabled(false);
            ...
            et_dimming_prefix.setEnabled(false);
            ...
            switch_dimming_percent.setEnabled(true);
            ...
            et_dimming_prefix.setEnabled(switch_dimming_percent.isChecked());
        }
    }
    ...
    private void setAllSpeechSettings(){
        ...
        stDimmingPrefix = et_dimming_prefix.getText().toString();
            if (stDimmingPrefix.isEmpty()) stDimmingPrefix = Global.EMPTY;
        ...
        try {
            ...
            jsonObj.put(Global.SPEECH_SETTING_DIMMING_PERCENT_CHECK, switch_dimming_percent.isChecked());
    ...
    private void update_UI() {
        ...
        switch_dimming_percent.setChecked(isDimmingPercent);
        ...
        if (!stDimmingPrefix.equals(Global.EMPTY))      et_dimming_prefix.setText(stDimmingPrefix);
        else                                            et_dimming_prefix.getText().clear();
